...
public class ViewInfoPlanet : MonoBehaviour
{
    ...
    public void SetDataTerra(Terra terra, Terra terraAnterior)
    {
        ...
        ShowInfo(recursosCanviXTerra, (terra.materials[0]-terraAnterior.materials[0]).ToString());
        ShowInfo(consumXTerra, terra.consum[0].ToString());
        ShowInfo(recursosYTerra, terra.materials[1].ToString());
        ShowInfo(recursosCanviXTerra, (terra.materials[1] - terraAnterior.materials[1]).ToString());
        ShowInfo(consumYTerra, terra.consum[1].ToString());
        ShowInfo(recursosZTerra, terra.materials[2].ToString());
        ShowInfo(recursosCanviXTerra, (terra.materials[2] - terraAnterior.materials[2]).ToString());
